...
object HotItems {
  def main(args: Array[String]): Unit = {
    ...
    val dataStream = env.readTextFile("E:\\toncent\\work\\bigdata-example\\flink-example\\src\\main\\resources\\UserBehavior.csv")
    //val dataStream = env.addSource( new FlinkKafkaConsumer[String]("wc", new SimpleStringSchema(), properties) )
      .map( data => {
