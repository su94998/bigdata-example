package com.sutao.streaming.app.mock

import java.text.SimpleDateFormat
import java.util.{Date, UUID}

import com.sutao.model.{CityInfo, ProductInfo, UserInfo, UserVisitAction}
import com.sutao.util.{RanOpt, RandomDate, RandomNum, RandomOptions}
